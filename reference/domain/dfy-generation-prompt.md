# DFY Generation Master Prompt

**Purpose:** Paste client's onboarding form responses → AI generates all deliverables
**Time:** 15-20 minutes of AI generation, then you review
...
3. Replace `[PASTE FORM RESPONSES HERE]` with the client's completed form
4. Let AI generate everything
5. Review, refine, package
...
- [ ] Zone of genius statement is specific and differentiated
- [ ] ICP matches real people they've helped
- [ ] Pain points use THEIR clients' language, not jargon
- [ ] Origin story is authentic and compelling
- [ ] Offer document is clear and complete
- [ ] Landing page copy flows and addresses objections
- [ ] Emails have personality (not generic)
- [ ] Ads have strong hooks
- [ ] Messaging map is usable reference
- [ ] Market research is accurate

### Common Refinements Needed

1. **Too generic** — Add specific details from their form
2. **Wrong tone** — Match their voice (formal vs casual)
3. **Missing objections** — Add any they mentioned in form
4. **Price not mentioned** — Ensure it's in offer doc and landing page
5. **Weak hooks** — Strengthen ad hooks with more specific pain

### Packaging

After review, organize into:

```
[Client Name] - Client Ready Funnel Bundle/
├── 01-Zone-of-Genius-Statement.md
├── 02-Ideal-Client-Profile.md
├── 03-Pain-Points-Map.md
├── 04-Origin-Story.md
├── 05-Offer-Document.md
├── 06-Landing-Page-Copy.md
├── 07-Email-Welcome-Sequence.md
├── 08-Ad-Copy-Variations.md
├── 09-Messaging-Map.md
├── 10-Market-Research.md
└── 00-Quick-Start-Guide.md
```

Total: 100+ pages when formatted in Google Docs.
...
| Step | Time |
|------|------|
| Paste form + run prompt | 2 min |
| AI generates | 15-20 min |
| Review + refine | 2-3 hours |
| Package into docs | 30 min |
| **Total** | **~3-4 hours** |

At $397 per client, that's ~$100-130/hour for your time.
