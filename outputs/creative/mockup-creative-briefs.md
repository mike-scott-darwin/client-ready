...
### 5 Components (for mockup devices)

| Device | Headline | Subhead/Callout |
|--------|----------|-----------------|
| **Main Monitor** | THE CLIENT READY OFFER SYSTEM | (Michael photo + handshake graphic) |
| **Spiral Notebook** | 5 AI EXTRACTION PROMPTS | "AI Does The Thinking For You" |
...
### Color Scheme
- Consider gold/premium accent to differentiate from lower tiers
- Keep teal base for brand consistency
...
2. Component names (medium)
3. Subheads/callouts (smallest)

### What NOT to Include
- Price (handled in sales copy, not mockup)
- Guarantees (handled in sales copy)
...
Please provide:
1. PNG with transparent background (for landing pages)
2. JPG on black background (for ads)
3. Individual component PNGs (for flexibility)

Dimensions:
- Hero mockup: 1200x800px minimum
- Social/ad versions: 1080x1080px square
