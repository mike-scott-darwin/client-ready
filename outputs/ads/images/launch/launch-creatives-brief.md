---
type: output
subtype: image-creatives
date: 2026-02-22
status: ready
linked_output: outputs/ads/launch-strategy.md
...
Nobody's asking if you have an offer
...
```
The reason a funnel doesn't convert
usually has nothing to do with the funnel.
...
**Format:** Side-by-side split (left = BEFORE, right = AFTER)

**Left side (BEFORE):** A messy, vague offer description. Type this in a plain text doc or Notes app:

```
I help people with mindset and
confidence. I do 1:1 coaching
and group programs. I also do
workshops. My prices start at...
um... it depends.
```

**Right side (AFTER):** A clean, one-sentence offer pulled from the system output:
...
**Label:** "BEFORE" / "AFTER" in small text at top of each side.
...
**Ad naming:** `Problem Aware - [Format] - Content Merry-Go-Round`
...
```
Posting 3x a week for 12 months
and nobody's buying.

It's not the algorithm.
It's the offer underneath.
```
...
Consistency without a clear offer
just creates more content nobody buys.
```

---

### CMR-02: Product Reveal

**Screen:** Screenshot showing the full system overview — all 5 prompts listed with descriptions visible.

**Title overlay:** "What to do instead of posting more content"
...
**Left side (BEFORE):** Screenshot of an Instagram-style content calendar or posting grid. Show 30+ posts with engagement metrics (likes, comments). Add a label:

```
365 posts. 4,200 followers.
0 clients.
```

**Right side (AFTER):** Screenshot of the offer document output from the system. Add a label:
...
### CMR-04: Testimonial Proof

**Screen:** The "Ideal Client Profile" section of the system visible in background.

**Overlay quote:**

> "Caught in some kind of cyclone whirlwind... just clutching at straws and then throwing them back out there"
> — Robin
...
**Ad naming:** `Solution Aware - [Format] - Clarity Unlock`
...
**Left side (BEFORE):** A rambling "what I do" description in Notes app:

```
So basically I help people who are
struggling with like confidence and
also some mindset stuff and I do
coaching but also courses and
I'm thinking about maybe doing
group stuff too and my prices are
...
### CU-04: Testimonial Proof

**Screen:** The AI prompts section visible in background.

**Overlay quote:**

> "Absolute clarity on who I'm serving, exactly what it is that they need and how to deliver that"
> — Wendy, coach for artists
...
|--------|-----------|-----|
| 1:1 | 1080 × 1080 | Feed (Facebook + Instagram) |
| 9:16 | 1080 × 1920 | Stories + Reels |

**For product reveals, before/afters, testimonials, section zooms:** Build at 9:16 with all content in center 1:1 safe zone. Crop for square. One design → two uploads.

**Tools needed:** Canva (free) for overlays, or CapCut for face cam circle. Nothing else.
