...
Free newsletters (e.g. Sabrina Ramonov's) already give copy-paste value — that's how they build a list to
sell something else. **This is paid ($37/mo).** So "they can use it" is necessary but NOT sufficient. Every
issue must clear this bar or it's a free-tier issue you shouldn't send as paid:

1. **A done-for-you asset they ship this week** — the actual copy/template/structure, filled in, not a
