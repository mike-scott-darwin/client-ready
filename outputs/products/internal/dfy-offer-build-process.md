...
Client purchases OTO1 ($197) → answers 8 questions → Claude API generates 4 deliverables → Michael reviews → client receives package within 48 hours.
...
**DFY Lite:** Same API call, but add to user message: "This is a DFY Lite order. Generate only Deliverable 1 (ICP) and Deliverable 2 (Offer Document). Skip landing page copy and ad hooks."
...
- [ ] **Landing page copy** sounds like THEM — mirrors their language from the questionnaire
...
- Landing page sounds like Michael, not them → rewrite key sections in their voice
...
Section 3: Landing Page Copy (DFY only)
...
3. Copy your landing page copy into your page builder (GHL, Carrd, WordPress).
4. Drop your ad hooks into Meta Ads Manager when you're ready to run traffic.
...
- [ ] GHL form created with 8 questions + field labels
